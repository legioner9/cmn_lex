    ...
    [quia] quia         - [по причине] потому что
    [etct] et cetera    - [ряд этому подобных] и так далее
    [c]a[r]go           - [сопровождающая сущность] попутный груз
        [crl]                 - [сопровождающая библиотека]
        [crd]                 - [сопровждающие данные]
    [ora] ora           - [куча [неструктурированное множество]] пляж
    [l]a[cu]s           - [неограниченное озеро [данных]] озеро 
    [sil]va             - [архив рабочих сущностей] лес
    [usu]               - [практ изучение] практика
    [p]e[b]b[l]e        - [аксиома] галечный камень
    [sp]e[cu]lum        - [зеркально-симметрично] зеркало
    [b]y                - [<a>B<a> за <a> следует <a>] за чем либо
                            - s_cBc string char by char
    [s]o[mn]ium         - [план] мечта
    quiris              - [] копье
    gladius             - [] меч
    galea               - [] шлем
    [c]a[st]ra          - [фреймворк] лагерь
